...
export class ParticipanteName {
  ...
  public static create(firstName: string, lastName: string): Result<AppNotification, ParticipanteName> {
    ...
    return Result.ok(new ParticipanteName(firstName, lastName));
  }
}